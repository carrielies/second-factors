            ...
            return (
                ...
                <Govuk>
                    ...
                    <Question title="Set your password" errors={this.state.errors}>
                        ...
                        <Field ref="password1" name="password1" errors={this.state.errors} labelText="Password" />
                        <Field ref="password2" name="password2" errors={this.state.errors} labelText="Confirm Password" />
                        <br/>
